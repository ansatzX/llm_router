...
- `future.md`: future work and design directions.

Do not mix speculative plans into the current-state documents. Future-facing
ideas belong in `future.md`.
